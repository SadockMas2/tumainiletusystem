    ...
    <div class="content">
        ...
        <div class="montant-section">
            <div class="content-line">
                ...
                <span><?php echo e(number_format($mouvement->montant, 2, ',', ' ')); ?> USD</span>
            </div>
        </div>
        ...
        <div class="content-line">
            ...
            <span><?php echo e(number_format($mouvement->solde_apres, 2, ',', ' ')); ?> USD</span>
        </div>
    </div>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\TUMAINI LETU SYSTEM\TUMAINI_LETU_SYSTEM\resources\views/bordereau-mouvement.blade.php ENDPATH**/ ?>