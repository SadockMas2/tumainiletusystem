...
<body class="font-sans antialiased">
    <div class="w-full max-w-4xl mx-4">
        ...
        <div class="credit-card rounded-2xl p-8">
                ...
                <div class="info-item bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-800"><?php echo e($compte->devise); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="<?php echo e(route('credits.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div id="simulation" class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200 hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        <div class="bg-white rounded-lg p-3 border border-blue-200">
                            ...
                            <p id="sim-montant" class="text-lg font-bold text-blue-600">0 <?php echo e($compte->devise); ?></p>
                        </div>
                        <div class="bg-white rounded-lg p-3 border border-blue-200">
                            <p class="text-sm text-gray-600">Intérêts Totaux</p>
                            <p id="sim-interets" class="text-lg font-bold text-orange-600">0 <?php echo e($compte->devise); ?></p>
                        </div>
                        <div class="bg-white rounded-lg p-3 border border-blue-200">
                            <p class="text-sm text-gray-600">Montant Total</p>
                            <p id="sim-total" class="text-lg font-bold text-green-600">0 <?php echo e($compte->devise); ?></p>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\TUMAINI LETU SYSTEM\TUMAINI_LETU_SYSTEM\resources\views/credits/create.blade.php ENDPATH**/ ?>